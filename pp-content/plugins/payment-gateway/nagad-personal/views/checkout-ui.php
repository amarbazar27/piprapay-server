    ...
    if(isset($_POST['nagad-personal'])){
        if($_POST['trxid'] == ""){
            ...
            if($check_transactionid['status'] == false){
                $verify_status = pp_verify_transaction($payment_id, $plugin_slug, 'Nagad', $_POST['trxid']);
            ...
            <div class="payment-form">
                  <ul class="list-unstyled">
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Dial <span class="text-primary fw-semibold">*167#</span> or open the <span class="text-primary fw-semibold">Nagad</span> app.
                      </p>
                    </li>
                    ...
                    <li class="d-flex">
                      ...
                      <span class="text-primary fw-semibold bg-primary bg-opacity-10 px-2 py-1 rounded">
                        <?php 
                          ...
                          $nagad_number = !empty($metadata['nagad_number']) ? $metadata['nagad_number'] : $settings['payment_number'];
                          echo htmlspecialchars($nagad_number);
                        ?>
                      </span>
                      <button class="btn btn-primary btn-sm ms-2 px-2 py-1 d-inline-flex align-items-center btn-number-copy" onclick="copyText('<?php echo htmlspecialchars($nagad_number)?>', 'btn-number-copy')">
                    ...
                    <li class="d-flex">
                      ...
                      <p class="mb-0">
                        Now enter your <span class="text-primary fw-semibold">Nagad</span> PIN to confirm.
                      </p>
                    </li>
    ...
    <script>
        ...
        document.querySelector('.btn-pay').addEventListener('click', function() {
            ...
            if(trxid == ""){
                ...
                ({
                    type: "POST",
                    url: "<?php echo pp_get_paymentlink($payment_id)?>?method=nagad-personal",
                    data: { "nagad-personal": "<?php echo $payment_id?>", "trxid": trxid, "number": number },
